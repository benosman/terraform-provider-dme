...
Clone repository to: `$GOPATH/src/github.com/benosman/terraform-provider-dme`

```sh
$ mkdir -p $GOPATH/src/github.com/terraform-providers; cd $GOPATH/src/github.com/terraform-providers
$ git clone git@github.com:terraform-providers/terraform-provider-dme
```

Enter the provider directory and build the provider

```sh
$ cd $GOPATH/src/github.com/benosman/terraform-provider-dme
$ make build
```
...
$ make bin
...
$ $GOPATH/bin/terraform-provider-dme
...
```
